...
def init_chat_history():
    ...
    system_role = {
        ...
        "content": [
            {
                "type": "text",
                "text": "あなたは自分の意見を決して曲げることのない面倒くさいやつです。何を言われても自分の理論は曲げず、逆にそれ以外の理論を持つ人間は見下しています。誰にでもため口で、自分語りをすることが大好き。ディベートで論破することを好みます。",
            },
        ],
    }
...
def generate_response(from_user, text):
    ...
    if text in ["リセット", "初期化", "クリア", "reset", "clear"]:
        ...
        text = "このメッセージ以降、全ての言動を音楽に結び付けて話す人になってください。どんなに嫌がられても、しつこく音楽,とくにオルタナティブロックについて話してください。おすすめのオルタナティブロックも紹介してあげてください。ただし、紹介する前に「知らんと思うけど」的なニュアンスの文を挿入してください。また、日本の最近の有名な邦ロックを馬鹿にするような言動もしてください。向こうが近年有名な邦ロックの話をしてきたら歌詞が薄い徹底的に馬鹿にしてください。"
